...
module.exports = function(app) {
  ...
  app.post("/api/post/create-folder", controller.createFolder);
  // Save Post To Folder (Bookmark)
  app.post("/api/post/save-post-to-folder", controller.saveBookmarkPost);
  // Folder Listing (Bookmark)
  app.get("/api/post/folder-listing", controller.folderListing);
  // Post inside Folder (Bookmark)
  app.get("/api/post/folder-post-listing", controller.folderPostListing);
